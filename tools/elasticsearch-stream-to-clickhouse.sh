...
# Поднимаем ClickHouse, официальный ClickHouse MCP и отдельный long-running stream connector.
docker compose --profile elasticsearch up -d clickhouse mcp-clickhouse
