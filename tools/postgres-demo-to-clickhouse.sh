...
export POSTGRES_SOURCE_TABLE_INCLUDE_LIST="$POSTGRES_SOURCE_SCHEMA.$POSTGRES_SOURCE_TABLE"
...
export CLICKHOUSE_SINK_TOPICS="$POSTGRES_SOURCE_TOPIC"
export CLICKHOUSE_TOPIC_TABLE_MAP="$POSTGRES_SOURCE_TOPIC=$CLICKHOUSE_SINK_TABLE"
...
docker compose run --rm --build \
  ...
  -e POSTGRES_SOURCE_TABLE_INCLUDE_LIST \
  ...
  -e CLICKHOUSE_SINK_TOPICS \
  -e CLICKHOUSE_TOPIC_TABLE_MAP \
  connectors-init
